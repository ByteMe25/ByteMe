...
\begin{itemize}
    ...
    \item \textbf{Scenario principale}:
        \begin{itemize}
            ...
            \item Il sistema elabora in tempo reale la sintassi Markdown
            \item Il sistema mostra l'anteprima formattata nel pannello di preview
...
\subsubsection{UC-1.5 - Annullamento modifica (Undo)}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.6 - Ripristino modifica (Redo)}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.7 - Modifica del testo tramite barra degli strumenti}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.7.1 - Applicazione grassetto al testo}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.7.2 - Applicazione corsivo al testo}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.7.3 - Applicazione barrato al testo}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    \item \textbf{Descrizione}: Formattazione del testo come barrato tramite barra degli strumenti
    \item \textbf{Precondizioni}: È presente testo selezionato nell'editor
    \item \textbf{Postcondizioni}: Il testo selezionato viene formattato come barrato
    \item \textbf{Scenario principale}:
        \begin{itemize}
            \item L'utente seleziona il testo da rendere barrato
            \item L'utente clicca sul pulsante "Barrato" nella toolbar
            \item Il sistema applica la sintassi Markdown per il barrato
            \item Il testo viene visualizzato barrato nell'anteprima
        \end{itemize}
\end{itemize}

\subsubsection{UC-1.7.4 - Gestione intestazioni e struttura documento}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.7.5 - Inserimento liste ed elenchi}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.7.6 - Inserimento link e riferimenti}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.8 - Modalità di visualizzazione editor}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.9 - Supporto caratteri multilingua (Unicode)}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-1.10 - Ricerca nel testo (opzionale)}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale}:
        \begin{itemize}
            ...
            \item Ogni nuova operazione AI genera testo che viene inserito nell'editor sotto alla porzione di testo interessata
        ...
        \begin{itemize}
            \item Il sistema formatta automaticamente il testo generato con:
                \begin{enumerate}
                    ...
                    \item Una riga separatrice orizzontale (---) (opzionale)
                \end{enumerate}
            \item L'utente può modificare sia il testo originale sia il testo generato dall'AI togliendo la formattazione automatica
        \end{itemize}
    \item \textbf{Estensioni}:
        \begin{itemize}
            \item L'utente modifica il testo generato dall'AI:
                \begin{enumerate}
                    \item Il sistema elimina automaticamente il colore di sfondo che contraddistingue il testo generato
...
\subsubsection{UC-2.5.5 - Gestione del Testo Tradotto Generato}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    ...
    \item \textbf{Scenario principale}:
        \begin{itemize}
            ...
            \item Il sistema mostra la traduzione nell'editor di testo sotto il testo originale, distinguendo le due porzioni di testo con:
                \begin{enumerate}
                    \item Una riga separatrice orizzontale (---) (opzionale)
                    \item Una riga di commento in corsivo: Generato da AI - Traduzione in [lingua] - [data/ora]
                    \item Il testo tradotto con sfondo leggermente differente (es. grigio chiaro)
                \end{enumerate}
...
\subsubsection{UC-2.7.7 - Gestione dell'Analisi Critica Generata}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    ...
    \item \textbf{Scenario principale}:
        \begin{itemize}
            ...
            \item Il sistema inserisce l'analisi sotto il testo analizzato distinguendola dal testo tramite:
                \begin{enumerate}
                    \item Una riga separatrice orizzontale (---)
                    \item Una riga di intestazione in grassetto: Generato da AI - Analisi [Cappello] - [data/ora]
                    \item Sfondo colorato specifico per il cappello (bianco, rosso, nero, giallo, verde, blu) (opzionale)
                \end{enumerate}
    ...
    \item \textbf{Estensioni}:
        \begin{itemize}
            \item L'utente ha generato analisi con più cappelli sullo stesso testo. In questo caso il sistema organizza le analisi nell'editor con:
                \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Il testo generato è distinto da altro testo presente nell'editor tramite:
                \begin{enumerate}
                    ...
                    \item Sfondo colorato distintivo che identifica il testo generato dall'AI
                    \item Linea separatrice dal testo già presente nell'editor (opzionale)
                \end{enumerate}
...
\subsubsection{UC-3.1 - Rimozione file caricato}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    ...
    \item \textbf{Estensioni}:
        \begin{itemize}
            \item Utente clicca no nella schermata "Sei sicuro di voler rimuovere?":
                \begin{enumerate}
                    \item Il file non viene rimosso
                \end{enumerate}
        \end{itemize}
\end{itemize}


\subsubsection{UC-3.2 - Errore: Formato file non supportato}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-3.3 - Errore: File troppo grande}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-3.4 - Errore: File corrotto o danneggiato}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    \item \textbf{Descrizione}: Utente desidera di stampare il documento senza doverlo prima esportare
