...
\hline
RO-F-47 & L'utente può caricare/aprire un file dal proprio dispositivo all'interno dell'editor & UC-3.* \\
\hline
RO-F-48 & Il sistema deve supportare il caricamento tramite dialogo di esplorazione file (file picker) & UC-3.0.* \\
\hline
RO-F-49 & Il sistema deve permettere all'utente di rimuovere il file che ha caricato (chiudendo il documento o l'editor) & UC-3.3 \\
\hline
RO-F-50 & Prima di procedere con il caricamento di un file, il sistema chiede conferma all'utente & UC-3.0 \\
\hline
RO-F-51 & Il sistema deve consentire l'esportazione del documento in formato PDF. & UC-4.0, UC-4.1\\
\hline
RO-F-52 & Il sistema deve essere in grado di convertire il documento da Markdown al formato selezionato dall'utente. & UC-4.0, UC-4.0, UC-4.1, UC-4.1.1, UC-4.1.2, UC-4.1.3, UC-4.1.4\\
\hline
RO-F-53 & Il sistema deve controllare che il range di pagine inserito dall'utente sia valido (che non superi il numero di pagine presenti o che non sia un numero negativo). & UC-4.2.1, UC-4.3.1\\
\hline
RO-F-54 & Il sistema deve permettere di poter scaricare il file nel dispositivo dell'utente. & UC-4.0\\
\hline
RO-F-55 & Il sistema deve potersi collegare a un dispositivo di stampa. & UC-4.3\\
\hline
...
\hline
RO-Q-15 & Il sistema deve fornire un feedback visivo immediato all'utente (messaggio di errore o di successo) al termine del tentativo di caricamento file & UC-3.* \\
\hline
...
\hline
RO-Q-19 & La dimensione massima consentita per il caricamento di un file deve essere limitata a una soglia definita e ragionevole & UC-3.2 \\
\hline
