...
\begin{longtable}[H]{|c|c|c|>{\raggedright\arraybackslash}p{0.3\textwidth}|c|}
    ...
    \label{tab:versionamento} \\
        ...
        \hline
        1.4.0 & 10/03/2026 & Giulia Barzon & Ultime correzioni ai requisiti & \\
        \hline
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale}:
        \begin{itemize}
            ...
            \item L'utente clicca sul pulsante della formattazione desiderata nella toolbar
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale}:
        \begin{itemize}
            ...
            \item Il sistema verifica il formato e le dimensioni del file
            \item Il sistema carica il contenuto del file nell'editor
        \end{itemize}
\end{itemize}
...
\subsubsection{UC-4.3 - Salvataggio file nel DataBase}
\begin{itemize}
    \item \textbf{Attore principale}: Utente autenticato
...
\hline
ROP-F-32 & Il sistema deve permettere ad un utente autenticato di selezionare un file dall'elenco di quelli salvati e aprirlo & UC-4.2 \\
\hline
...
\hline
ROP-F-35 & L'accesso ai file salvati nel database è consentito solo ad utenti autenticati. & UC-4.2 \\
\hline
ROP-F-36 & Il sistema deve permettere il salvataggio di un file in un sistema di persistenza non locale & UC-4.3 \\
\hline
ROP-F-37 & Il sistema deve notificare l'utente in caso di fallimento del salvataggio nel database. & UC-4.3 \\
\hline
ROP-F-38 & Il sistema deve associare ogni file al suo creatore & UC-4.3 \\
\hline
ROP-F-39 & Il sistema deve impedire il salvataggio di file nel database da parte di utenti non autenticati. & UC-4.3, UC-4.3.2 \\
\hline
ROP-F-40 & Il sistema deve impedire il salvataggio di un documento vuoto nel database. & UC-4.3.1 \\
\hline
ROP-F-41 & Un utente non autenticato che prova a salvare un file viene riportato alla pagina di login & UC-4.3.2 \\
\hline
...
\hline
RO-Q-9 & Il manuale utente deve documentare tutte le funzionalità obbligatorie del sistema e deve ottenere un Indice di Gulpease (IG) maggiore o uguale a 40. & PdQ – Indice di Gulpease, soglia accettabile \\
\hline
...
\hline
UC-4.3 & Salvataggio file nel database & ROP-F-36, ROP-F-37, ROP-F-38, ROP-F-39 \\
\hline
