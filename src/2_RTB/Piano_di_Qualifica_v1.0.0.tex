...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|X|c|}
        ...
        \hline
        TI-1 & \textbf{Health Check \gls{Database}}: \gls{Verifica} che il backend riesca a stabilire una connessione stabile con il \gls{database} PostgreSQL interrogando l'endpoint dedicato (\texttt{/\gls{api}/test-db-connection}) ed eseguendo una query di test. & ROP-F-22 \\
        \hline
