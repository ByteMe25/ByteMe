...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.3\textwidth}|c|}
        ...
        \hline
        0.4.0 & 17/01/2026 & Elisa Marchioro & Sistemata macroarea 3 e 4 e i suoi diagrammi &  \\
        \hline
        0.3.9 & 15/01/2026 & Giulia Barzon & Aggiunti diagrammi macroarea 1 e 2 &  \\
        \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../UCimg/UC3.1_3.2_3.3_3.3.1_errori.jpg}
...
\begin{itemize}
    ...
    \item \textbf{Scenari secondari}:
        \begin{itemize}
            ...
            \item Esportazione in MD
            \item Esportazione in HTML
            \item Esportazione in ODT
            \item Esportazione in DOCX
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenari secondari}:
        \begin{itemize}
            \item Esportare un range di pagine del documento
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenari secondari}:
        \begin{itemize}
            \item Stampare selezionate pagine del documento
        \end{itemize}
\end{itemize}
