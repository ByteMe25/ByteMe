...
\begin{longtable}[H]{|c|c|c|>{\raggedright\arraybackslash}p{0.3\textwidth}|c|}
    ...
    \label{tab:versionamento} \\
        ...
        \hline
        0.5.4 & 07/02/2026 & Elisa Marchioro & Correzione macroarea 2 & \\
        \hline
        0.5.3 & 06/02/2026 & Elisa Marchioro & Correzione macroarea 2 & \\
        \hline
        0.5.2 & 05/02/2026 & Elisa Marchioro & Mini modifiche & \\
        \hline
...
\subsubsection{UC-2.1 - Interazione con le proposte di testi generati dall’AI}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-2.1.1 - Accettazione del testo generato dall'AI}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    ...
    \begin{itemize}
        ...
        \item Il testo generato viene integrato nel documento nell'editor
    \end{itemize}
\end{itemize}
...
\subsubsection{UC-2.1.4 - Annullamento dell’operazione}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema elabora la richiesta e invia il testo al LLM
        \item Il sistema riscrive il testo corretto
        \item L'utente conferma la proposta
        \item Il sistema inserisce il testo corretto nell'editor
    \end{itemize}
    \item \textbf{Estensioni}:
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'utente conferma la proposta 
        \item Il sistema inserisce la critica nell'editor, dopo il testo originale selezionato
    \end{itemize}
    \item \textbf{Estensioni}:
    \begin{itemize}
...
\hline
RO-F-31 & Ogni generazione di testo dell'agente esterno viene inclusa in un registro delle generazioni, anche quelle annullate dall'utente & UC-2.1.4 \\
\hline
