...
\begin{longtable}[H]{|c|c|c|>{\raggedright\arraybackslash}p{0.3\textwidth}|c|}
    ...
    \label{tab:versionamento} \\
        ...
        \hline
        1.3.0 & 5/03/2026 & Elisa Marchioro & Mini fix ai casi d'uso e correzioni diagrammi & \\
        \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../UCimg/UC4.0.6jpg}
...
\subsubsection{UC-4.1.1 - Stampare selezionate pagine del documento}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\hline
RD-F-15 & Il sistema deve permettere all'utente di scegliere se stampare tutto il documento o un range di pagine selezionate & UC-4.1, UC-4.1.1\\
\hline
...
\hline
UC-4.1 & Stampare il documento & RO-F-75, RO-F-79, RO-F-80, RD-F-7 \\
\hline
UC-4.1.1 & Stampare pagine selezionate & RD-F-15 \\
\hline
