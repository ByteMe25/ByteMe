...
\subsubsection{UC-1.8.3 - Applicazione sottolineatura al testo selezionato}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    \item \textbf{Descrizione}: L’utente può visualizzare un registro di tutte le generazioni AI che ha effettuato
    \item \textbf{Precondizioni}: Sono state eseguite una o più operazioni AI
    \item \textbf{Postcondizioni}: L’utente visualizza il registro delle generazioni AI
    \item \textbf{Scenario principale}:
        \begin{itemize}
            \item L'utente ha effettuato una o più operazioni AI
            ...
            \item se l'utente cambia documento o chiude la pagina, l'utente perde lo storico delle generazioni AI effettuate per quel documento
        \end{itemize}
        \item \textbf{Estensioni}:
        \begin{itemize}
            \item L'utente ha effettuato il log-in
        \end{itemize}
\end{itemize}

\subsubsection{UC-2.0.1 - Visualizzazione storico generazioni AI per utente registrato}
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    \item \textbf{Descrizione}: Ogni volta che l’utente effettua un’operazione AI può decidere se confermare, eliminare o rigenerare la proposta
    \item \textbf{Precondizioni}: E’ stata eseguita un’operazione AI
    \item \textbf{Postcondizioni}: L’utente ha confermato, eliminato o rigenerato la proposta AI e la proposta è stata inserita nello storico delle generazioni AI
    \item \textbf{Scenario principale}:
    \begin{itemize}
        \item L’utente seleziona un’operazione AI da eseguire nel testo selezionato o non selezionato 
        \item Ogni nuova operazione AI può essere confermata, eliminata o rigenerata dall’utente
        \item Ogni generazione, a prescindere dalla scelta dell’utente, viene inserita nello storico delle generazioni AI
    \end{itemize}
    \item \textbf{Estensioni}:
    \begin{itemize}
        \item Conferma proposta
        \item Elimina proposta
        \item Rigenera proposta
...
\subsubsection{UC-2.1.4 - Annullamento dell’operazione AI}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-2.1.5 - Errore dal LLM}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
