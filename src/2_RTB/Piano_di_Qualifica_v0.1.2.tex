...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.4\textwidth}|c|}
        ...
        \hline
        0.1.3 & 11/01/2026 & Elisa Marchioro & Aggiunte metriche qualità di prodotto & \\
        \hline
...
\textbf{Metrica} & \textbf{Scopo della metrica} & \textbf{Soglia Accettabile} & \textbf{Soglia Ottimale} \\
\hline
Response Time & Tempo medio per mostrare suggerimenti AI o completamenti di testo & 500 ms & 100 ms \\ \hline
AI Processing Time & Tempo medio necessario all’AI per generare una correzione o completamento & 1 sec & 0.5 sec \\
\hline
\end{tabular}
...
Cyclomatic Complexity & Misura della complessità del codice per facilitarne modifiche future & 15 & 10 \\ \hline
