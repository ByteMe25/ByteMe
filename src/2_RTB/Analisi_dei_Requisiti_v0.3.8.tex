...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.3\textwidth}|c|}
        ...
        \hline
        0.3.8 & 15/01/2026 & Giulia Barzon & Sistemati casi ed estensioni macroarea 2 &  \\
        \hline
...
\subsubsection{UC-1.0.1 - Interruzione della connesione Internet}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale}:
        \begin{itemize}
            ...
            \item Il testo formattato viene visualizzato nell'are di anteprima
        \end{itemize}
    \item \textbf{Estensioni}:
        \begin{itemize}
...
\subsubsection{UC-1.8.5 - Applicazione elementi di struttura}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L’utente può accettare, eliminare o rigenerare la risposta dell’AI
...
\subsubsection{UC 2.1.1 - Modifica del testo generato}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\begin{itemize}
    ...
    \begin{itemize}
        \item L’utente individua un blocco di testo generato dall’AI
        \item L’utente visualizza l’opzione “Elimina” accanto alla generazione
        \item L’utente seleziona “Elimina”
...
\subsubsection{UC 2.1.4 - Visualizzazione solo del testo utente}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    \item \textbf{Descrizione}: L’utente può scegliere di visualizzare solo il testo che ha scritto nel documento, senza visualizzare le sezioni di testo generato dall’AI
    \item \textbf{Precondizioni}: Sono state eseguite una o più operazioni AI e i relativi testi generati sono stati inseriti nell’editor
    \item \textbf{Postcondizioni}: L’utente visualizza solo il testo originario senza le generazioni AI
    \item \textbf{Scenario principale}:
    \begin{itemize}
        \item L’utente seleziona l’opzione “Visualizza solo testo utente”
        \item L’editor mostra solo il testo scritto dall’utente, rimuovendo le generazioni AI dalla visualizzazione
    \end{itemize}
\end{itemize}

\subsubsection{UC 2.1.5 - Visualizzazione solo del testo generato dall’AI}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
    \item \textbf{Descrizione}: L’utente può scegliere di visualizzare solo il testo che è stato generato dalle funzionalità AI, senza vedere il testo originario
    \item \textbf{Precondizioni}: Sono state eseguite una o più operazioni AI e i relativi testi generati sono stati inseriti nell’editor
    \item \textbf{Postcondizioni}: L’utente visualizza solo le generazioni nel documento
    \item \textbf{Scenario principale}:
    \begin{itemize}
        \item L’utente seleziona l’opzione “Visualizza solo testo generato”
        \item L’editor mostra solo i blocchi di testo generato dall’AI, rimuovendo il testo scritto dall’utente dalla visualizzazione
    \end{itemize}
\end{itemize}
...
\subsubsection{UC-2.4.1 - Mancata selezione della lingua di destinazione}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-2.6.1 - Testo insufficiente per analisi critica}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-2.6.2 - Mancata selezione della modalità di analisi}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
...
\subsubsection{UC-2.9.1 - Gestire errori di visualizzazione delle mappe concettuali generate}
\begin{itemize}
    \item \textbf{Attore principale}: Utente generico
