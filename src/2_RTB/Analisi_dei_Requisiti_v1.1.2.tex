...
\begin{table}[H]
    \centering
    \begin{tabular}{|c|>{\raggedright\arraybackslash}p{0.6\textwidth}|c|}
        \hline
        \textbf{Requisito} & \textbf{Descrizione} & \textbf{Casi d'uso correlati}\\
        \hline
        RO-F-1 & Descrizione... & UC-1.0 \\
        \hline
        RO-F-2 & Descrizione... & UC-1.1 \\
        \hline
        RO-F-3 &Descrizione... & UC-2.0 \\
        \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|>{\raggedright\arraybackslash}p{0.6\textwidth}|c|}
        ...
        \textbf{Requisito} & \textbf{Descrizione} & \textbf{Casi d'uso correlati}\\
        \hline
        RO-V-1 & Descrizione... & UC-1.0 \\
        \hline
        RO-V-2 & Descrizione... & UC-1.1 \\
        \hline
        RO-V-3 &Descrizione... & UC-2.0 \\
        \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|>{\raggedright\arraybackslash}p{0.6\textwidth}|c|}
        ...
        \textbf{Requisito} & \textbf{Descrizione} & \textbf{Casi d'uso correlati}\\
        \hline
        RO-Q-1 & Descrizione... & UC-1.0 \\
        \hline
        RO-Q-2 & Descrizione... & UC-1.1 \\
        \hline
        RO-Q-3 &Descrizione... & UC-2.0 \\
        \hline
    \end{tabular}
