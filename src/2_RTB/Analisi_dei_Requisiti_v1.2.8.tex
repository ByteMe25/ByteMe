...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.4\textwidth}|c|}
        ...
        \hline
        1.2.8 & 04/01/2026 & Tommaso Tombacco & Correzione requisiti macroarea 2 & Elisa Marchioro\\
        \hline
        1.2.7 & 02/01/2026 & Elisa Marchioro & Aggiunti requisiti macroarea 4 &  \\
        \hline
        1.2.6 & 01/01/2026 & Tommaso Tombacco & Piccole correzioni &  \\
        \hline
        1.2.5 & 01/01/2026 & Joseph Grant & Piccole correzioni e aggiunte &  \\
        \hline
        1.2.4 & 30/12/2025 & Giulia Barzon & Correzione requisiti macroarea 1 e inserimento diagrammi completi & Matteo Cuogo \\
        \hline
        ...
        \hline
        1.2.1 & 29/12/2025 & Tommaso Tombacco & Modifiche ad alcuni casi d'uso &  Matteo Cuogo\\ 
        \hline
        1.2.0 & 28/12/2025 & Joseph Grant & Aggiunta dei requisiti macroarea 1, 2, 3 e 5 &  \\ 
        \hline
...
\hline
RO-F-22 & Il sistema permette di inviare del testo ad un agente esterno & UC-2.0, UC-2.6, UC-2.7, UC-2.7.*, UC-2.8, UC-2.9, UC-2.10, UC-2.11 \\
\hline
RO-F-23 & Una volta generato, il testo dell'agente esterno viene inserito nell'editor dal sistema, in modo che tutte le funzionalità dell'editor siano applicate anche al testo generato & UC-2.0, UC-2.2, UC-2.6, UC-2.7, UC-2.7.x, UC-2.8 \\
\hline
RO-F-24 & Il sistema permette all'utente di eliminare il testo generato da un agente esterno & UC-2.0, UC-2.2, UC-2.3, UC-2.4, UC-2.5.*, UC-2.6 \\
\hline
...
\hline
RO-F-26 & Il sistema permette l'invio di un prompt scritto dall’utente per la generazione del testo tramite agente esterno & UC-2.8 \\
\hline
RO-F-27 & Il sistema permette la modifica del testo generato inserito nell'editor & UC-2.3, UC-2.4, UC-2.5.*, UC-2.8, UC-2.11 \\
\hline
RO-F-28 & Il sistema permette la modifica del prompt da inviare ad un agente esterno & UC-2.8, UC-2.9, UC-2.10, UC-2.11 \\
\hline
RO-F-29 & L'utente deve poter accedere alle azioni sul testo tramite agente esterno in ogni momento & UC-2.0 \\
\hline
RO-F-30 & Ogni sezione che contiene testo ricevuto da un agente esterno include opzioni per eliminare o rigenerare il testo & UC-2.0, UC-2.2, UC-2.3, UC-2.4, UC-2.5.* \\
\hline
RO-F-31 & L'utente deve poter riassumere tutto o una parte selezionata del testo usando un agente esterno & UC-2.3 \\
\hline
RO-F-32 &  L'utente deve poter usare un agente esterno per riscrivere tutto o una parte selezionata del testo migliorandolo seguendo determinate specifiche come sintassi, stile e chiarezza & UC-2.4 \\
\hline
RO-F-33 & L'utente deve poter tradurre il testo usando un agente esterno in: inglese, italiano, tedesco, francese, spagnolo e cinese mandarino & UC-2.5.* \\
\hline
...
\hline
RO-F-40 & Il sistema deve consentire l'esportazione del documento in formato PDF. & UC-4.0, UC-4.1\\
\hline
RO-F-41 & Il sistema deve essere in grado di convertire il documento da Markdown al formato selezionato dall'utente. & UC-4.0, UC-4.0, UC-4.1, UC-4.1.1, UC-4.1.2, UC-4.1.3, UC-4.1.4\\
\hline
RO-F-42 & Il sistema deve controllare che il range di pagine inserito dall'utente sia valido (che non superi il numero di pagine presenti o che non sia un numero negativo). & UC-4.2.1, UC-4.3.1\\
\hline
RO-F-43 & Il sistema deve permettere di poter scaricare il file nel dispositivo dell'utente. & UC-4.0\\
\hline
RO-F-44 & Il sistema deve potersi collegare a un dispositivo di stampa. & UC-4.3\\
\hline
RO-F-45 & Il sistema deve permettere all'utente di selezionare la stampante che preferisce tra quelle disponibili. & UC-4.3\\
\hline
...
\hline
RO-V-8 & L'agente esterno deve avere istruzioni sufficienti affinché il testo riscritto sia corretto grammaticalmente, sintatticamente e semanticamente e deve riflettere la richiesta dell'utente & UC-2.4 \\
\hline
RO-V-9 & Le sezioni create per la traduzione di un testo specificheranno la lingua di partenza e di fine & UC-2.5.* \\
\hline
RO-V-11 & All'agente esterno devono essere passate delle istruzioni ottimizzate per garantire una traduzione accurata nella lingua selezionata & UC-2.5, UC-2.5.* \\
\hline
RO-V-12 & Il sistema espone la sua limitazione nell'eseguire un'azione richiesta se i dati inviati non rispettano i limiti dell'agente esterno & UC-2.9, UC-2.10, UC-2.11 \\
\hline
...
\hline
RO-V-14 & L'operazione di esportazione o stampa non deve alterare o chiudere il documento originale nell'editor. & Tutti gli UC-4 \\
\hline
RO-V-15 & Il sistema deve collegarsi ad un LLM tramite API REST & UC-2.0, UC-2.2, UC-2.3, UC-2.4, UC-2.5, UC-2.5.x, UC-2.7, UC-2.7.x, UC-2.8, UC-2.9, UC-2.10, UC-2.11 \\
\hline
