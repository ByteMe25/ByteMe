...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|>{\raggedright\arraybackslash}p{0.25\textwidth}|>{\raggedright\arraybackslash}p{0.4\textwidth}|}
        ...
        \hline
        1.1.2 & 27/10/2025 & Tutto il gruppo & Revisione e approvazione finale \\
        \hline
        1.1.1 & 27/10/2025 & Giulia Barzon & Ultime modifiche dopo diario di bordo \\
        \hline
        1.1.0 & 25/10/2025 & Giulia Barzon & Migliorie al documento \\
        \hline
        1.0.0 & 24/10/2025 & Giulia Barzon & Stesura iniziale della lettera \\
        \hline
    \end{tabular}
...
Il gruppo ByteMe ha selezionato il capitolato C6 "Second Brain" dopo un'attenta valutazione, ritenendo che le sue caratteristiche si allineino perfettamente con le competenze che il team può offrire.
