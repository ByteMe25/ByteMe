...
\begin{titlepage}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|l|p{5cm}|}
            ...
            \hline
            \textbf{\gls{Verifica}} & Giulia Barzon, Elisa Marchioro, Matteo Cuogo \\
            \hline
            \textbf{Approvazione} & \\
            \hline
...
\begin{longtable}[H]{|c|c|c|>{\raggedright\arraybackslash}p{0.3\textwidth}|c|}
    ...
    \label{tab:versionamento} \\
        ...
        \hline
        1.4.1 & 11/03/2026 & Elisa Marchioroo & Mini fix & Tommaso Tombacco \\
        \hline
...
Per evitare ambiguità, i termini tecnici usati nel documento vengono definiti in modo più approfondito nel documento "\gls{Glossario} v.1.0.0" che si trova nella \gls{repository} del gruppo nella cartella "Documenti\textunderscore interni".
...
\begin{itemize}
    \item \gls{Norme di Progetto} v1.0.0 - Documento interno del gruppo ByteMe
...
\begin{itemize}
    ...
    \item Implementare un sistema di \textit{\gls{distant writing}} che permette di generare un testo completo a partire da un breve prompt dell'utente.
\end{itemize}
