...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        1.2.1 & 25/04/2026 & Tommaso Tombacco & Aggiunta sezione su analisi funzionalità riscrittura & \\
        \hline
...
\paragraph{Modello scelto}
La scelta finale è ricaduta sul modello \textbf{gemma3:4b}, che ha dimostrato un'elevata coerenza con gli input forniti, assenza di fenomeni di allucinazione e capacità di riscrivere testi informali o non strutturati in forma tecnica e formale.\\\\
