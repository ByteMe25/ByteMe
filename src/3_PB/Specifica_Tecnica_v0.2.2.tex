...
% GRAFICO per gli hooks dell'editor - DA CAMBIARE
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../UMLimg/UseEditor.jpg}
...
\begin{figure}[H]
    ...
    \caption{Architettura del modulo History: interazione tra l'hook useHistory e lo store Zustand.}
