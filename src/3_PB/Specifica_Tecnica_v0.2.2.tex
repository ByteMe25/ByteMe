...
Il sistema prevede tre implementazioni concrete che espongono in modo polimorfico i modelli \gls{Deepseek } (per operazioni di distant writing),  \gls{Gemma 3} (per il pensiero laterale dei Sei Cappelli, riscrittura del testo e correzione grammaticale) e \gls{Qwen 3} (per operazioni di riassunto).
\begin{itemize}
    \item \textbf{Attributi:}
\begin{itemize}
