...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        0.2.2 & 26/04/2026 & Giulia Barzon & Aggiornati diagrammi frontend & \\
        \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../UMLimg/componenti_view_editor.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../UMLimg/componenti_view_storico.jpg}
