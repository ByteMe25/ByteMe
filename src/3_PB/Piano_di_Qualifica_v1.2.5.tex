...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        1.2.5 & 29/04/2026 & Giulia Barzon & Aggiunti test di sistema & \\
        \hline
...
\section{Test di sistema - Fase PB}
I \textbf{test di sistema} (TS) rappresentano l'attività di analisi dinamica volta a verificare il comportamento dell'intero prodotto software nella sua interezza. Il loro scopo principale è accertare che il sistema integrato soddisfi tutti i requisiti funzionali, non funzionali e di qualità definiti nel documento di Analisi dei Requisiti. Trattandosi di test di tipo black-box, essi valutano il sistema dall'esterno concentrandosi esclusivamente sulla corrispondenza tra gli input forniti e gli output attesi, ignorando i dettagli della logica interna del codice. Questa fase costituisce un'attività di verifica interna al gruppo, eseguita a valle dei test di integrazione, ed è fondamentale per misurare il grado di copertura dei requisiti in preparazione al collaudo finale.
...
\caption{Tabella dei Test di Sistema} \label{tab:test_sistema} \\
\hline
...
\hline
TS-05 & \textbf{Azione:} L'utente clicca le icone di formattazione nella toolbar su un testo selezionato. \newline \textbf{Esito atteso:} I relativi tag Markdown vengono inseriti e l'anteprima mostra lo stile applicato. & RO-F-14, RO-F-15, RO-F-16, RO-F-17, RO-F-23, RO-F-24, RO-F-25 & S \\
\hline
TS-06 & \textbf{Azione:} L'utente inserisce intestazioni o link tramite i comandi della toolbar. \newline \textbf{Esito atteso:} Gli elementi vengono renderizzati correttamente nell'anteprima. & RO-F-18, RO-F-19, RO-F-22 & S \\
\hline
...
I \textbf{test di accettazione} (TA), o di collaudo, costituiscono la fase di validazione formale e definitiva del prodotto software prima del suo rilascio. A differenza delle precedenti fasi di verifica, il cui scopo è accertare se il sistema è stato "costruito nel modo giusto", il collaudo risponde alla domanda fondamentale della validazione: "è stato costruito il sistema giusto?". L'obiettivo esclusivo dei TA è dimostrare in modo oggettivo, attraverso l'esecuzione di specifici casi di prova, che il software consegnato soddisfa pienamente i bisogni e i requisiti utente concordati originariamente nel Capitolato d'appalto. Il superamento con successo di questa fase determina l'accettazione formale e la conclusione del progetto.
