...
\textbf{PB:} Analizzando il grafico del PV/EV nella fase PB si può notare una notevole differenza di ore di lavoro tra gli sprint della stessa fase PB e della fase precedente RTB.
In questa fase PB il gruppo ha incrementato il tempo impiegato nei vari sprint, tenendo in considerazione che a partire dallo sprint 9 la durata di uno sprint è stato ridotto ad una settimana.
