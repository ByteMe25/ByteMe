...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        0.1.2 & 25/04/2026 & Giulia Barzon & Aggiunti screenshoot mancanti & Joseph Grant \\
        \hline
        0.1.1 & 24/04/2026 & Elisa Marchioro & Piccoli fix & Giulia Barzon\\
        \hline
...
Per utilizzare \textbf{Second Brain} sul proprio computer, il metodo più semplice è l'utilizzo di \textbf{\gls{Docker}}. Questa tecnologia permette di "impacchettare" tutto il software necessario in contenitori pronti all'uso, evitando di dover installare manualmente linguaggi di programmazione specifici.
...
\begin{itemize}
    \item \textbf{Funzionamento}: Selezionando una lingua tra quelle supportate (Italiano, Inglese, Spagnolo, Francese, Tedesco, Cinese), il sistema avvia una traduzione semantica.
