...
Per evitare ambiguità, i termini tecnici usati nel documento vengono definiti in modo più approfondito nel documento "\gls{Glossario} v.1.0.0" che si trova nella \gls{repository} del gruppo nella cartella "Documenti\textunderscore interni" o consultabile nel sito web del gruppo, al seguente link:\\
...
\begin{itemize}
  ...
  \item \textit{\gls{Norme di Progetto}} versione 1.0.0
...
\begin{itemize}
    \item \textit{\gls{Analisi dei Requisiti}} versione 1.4.1
