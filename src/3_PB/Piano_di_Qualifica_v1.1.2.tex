...
\textbf{Codice} & \textbf{Descrizione} & \textbf{Stato} \\
    ...
    \hline
    \prossimoUT & \gls{Verifica} che la classe base definisca una variabile di classe \texttt{temperature} di default (float), necessaria per le configurazioni di base. & Pass \\
    \hline
\end{tabular}
...
\prossimoUT & \gls{Verifica} che la strategia Gemma utilizzi il modello corretto e accetti la \gls{temperatura}. & Pass \\ \hline
