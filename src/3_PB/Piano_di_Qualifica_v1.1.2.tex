...
\prossimoUT & Verifica che tutte le strategies producano due stringhe non vuote. & Pass \\ \hline
\prossimoUT & Verifica che le funzionalità di scrittura sono istanze di SimplePromptStrategy & Pass \\ \hline
\prossimoUT & Verifica che le traduzioni sono istanze di TranslationStrategy & Pass \\ \hline
\prossimoUT & Verifica che i cappelli sono istanze di DeBonoHatStrategy & Pass \\ \hline
\end{tabular}
