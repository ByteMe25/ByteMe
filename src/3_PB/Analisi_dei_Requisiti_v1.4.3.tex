...
\hline
RO-F-82 & Il sistema deve garantire la persistenza locale dello storico delle generazioni AI tramite browser storage (Zustand persist). & UC-2.* \\
\hline
...
\hline
RO-V-5 & Il backend dell'applicazione deve essere progettato come un gateway stateless; non deve mantenere sessioni o stati dei documenti sul server, delegando la gestione della persistenza interamente al client. & Capitolato \\
\hline
\addlinespace[1em]
