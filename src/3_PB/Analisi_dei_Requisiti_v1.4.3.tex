...
\begin{longtable}[H]{|c|c|c|>{\raggedright\arraybackslash}p{0.3\textwidth}|c|}
    ...
    \label{tab:versionamento} \\
        ...
        \hline
        1.4.3 & 20/04/2026 & Giulia Barzon & Aggiunti RO-F-81, RO-F-82, RO-F-83, ROP-F-43, ROP-F-44, ROP-F-45, RO-V-5 & \\
        \hline
...
\hline
RO-F-81 & Il sistema deve garantire la persistenza locale del testo nell'editor tramite browser storage (LocalStorage). & UC-1.* \\
\hline
RO-F-82 & Il sistema deve garantire la persistenza locale dello storico delle generazioni AI tramite browser storage (\gls{Zustand} persist). & UC-2.* \\
\hline
RO-F-83 & Il sistema deve impedire il caricamento di file di dimensioni superiori a 5MB. & UC-3.2 \\
\hline
...
\hline
RO-V-5 & Il backend dell'applicazione deve essere progettato come un gateway \gls{stateless}; non deve mantenere sessioni o stati dei documenti sul server, delegando la gestione della persistenza interamente al client. & Capitolato \\
\hline
\addlinespace[1em]
...
\hline
Funzionali & 83 & 15 & 45 & 143 \\
\hline
Vincolo & 5 & 0 & 0 & 5 \\
\hline
Qualità & 10 & 0 & 0 & 10 \\
\hline
\textbf{Totale} & 98 & 15 & 45 & 158 \\
\hline
\end{tabular}
