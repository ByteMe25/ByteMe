...
\noindent \textbf{PB:} Durante la fase di Product Baseline, l'EAC ha subito alcune fluttuazioni a causa dello sforzo intensivo richiesto dalla programmazione. In particolare, nello Sprint 14 l'EAC ha toccato un picco di 11.535,29 euro, superando momentaneamente il BAC a causa di un Cost Performance Index (CPI) sceso a 0.89 per chiudere il codice dell'MVP. Tuttavia, poiché il progetto si è concluso al 100\% con lo Sprint 15, la stima a finire è decaduta per coincidere con il costo effettivo cumulato (Actual Cost finale), assestandosi sul valore definitivo di 10.712,50 euro. Il progetto si chiude quindi in positivo, confermando un risparmio complessivo di circa 680 euro rispetto al preventivo iniziale.
...
\noindent \textbf{PB:} L'adozione di sprint settimanali a partire dallo \gls{Sprint} 9 ha portato a un incremento e a una maggiore densità del valore pianificato (PV). L'aspetto più rilevante della fase PB è la perfetta sovrapposizione tra la curva del PV e quella dell'EV: in ogni singolo sprint (dall'8 al 15), il team è riuscito a generare esattamente il valore pianificato, completando tutte le attività senza lasciare alcun debito tecnico o temporale. Il gruppo è riuscito a migliorare la pianificazione e il completamento delle attività.
...
\noindent \textbf{PB:} Il CPI in questa fase ha mostrato maggiore variabilità rispetto alla RTB. Si è registrato un calo significativo nello \gls{Sprint} 8 (0.66) dovuto all'adozione di React e di TypeScript e alla correzione di diversi documenti. L'indice si è poi stabilizzato attorno al valore 1.0 negli sprint centrali, per flettere nuovamente negli \gls{Sprint} 13 (0.91) e 14 (0.89), i più onerosi dal punto di vista della codifica dell'MVP. Lo \gls{Sprint} 15 finale si è chiuso con un CPI di 1.00.
