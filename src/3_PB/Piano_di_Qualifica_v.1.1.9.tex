...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        1.2.0 & 25/04/2026 & Elisa Marchioro & Aggiunta sezione e test integrazione & \\
        \hline
        1.1.9 & 25/04/2026 & Chiara Grossele & Aggiunta sezione riassunto del testo & \\
        \hline
        1.1.8 & 24/04/2026 & Joseph Grant & Aggiunta sezione \gls{distant writing} & Chiara Grossele\\
        \hline
...
In questa sezione è documentato lo studio svolto sulle capacità dei diversi modelli LLM a elaborare un riassunto su una porzione di testo dato. Tramite questa ricerca abbiamo potuto stabilire i tre modelli più adatti a svolgere questa funzionalità.
\paragraph{Confronto modelli e risultati}
La ricerca ha voluto testare i vari modelli per verificare la capacità di produrre un riassunto di qualità e coerente al testo fornito. Alla fine del test si è potuto valutare i diversi riassunti ottenuti e stabilire quali LLM fossero migliori in questo compito: \textbf{Qwen 3 (30B)},\textbf{Qwen 3.5 (27B)} e \textbf{\gls{Gemma 3} (27B)}.\\
