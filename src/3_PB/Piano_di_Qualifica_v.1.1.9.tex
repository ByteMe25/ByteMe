...
\paragraph{Confronto modelli e risultati}
La ricerca ha voluto testare i vari modelli per verificare la capacità di produrre un riassunto di qualità e coerente al testo fornito. Alla fine del test si è potuto valutare i diversi riassunti ottenuti e stabilire quali LLM fossero migliori in questo compito: \textbf{Qwen 3 (30B)},\textbf{Qwen 3.5 (27B)} e \textbf{Gemma 3 (27B)}.\\
Questi tre modelli hanno fornito tre riassunti fedeli al testo e completi con dettagli chiave, seguendo le indicazioni del prompt e mantenendo un tempo di risposta adeguato.\\
