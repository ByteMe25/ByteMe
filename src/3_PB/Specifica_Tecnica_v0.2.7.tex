...
\texttt{Axios}: è stata invece adottata un'architettura a due moduli distinti e complementari, 
in cui il Facade (apiClient.ts) si occupa del \textit{come} comunicare con il server, e aiCall.ts del 
