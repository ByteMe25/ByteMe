...
In un ambiente dichiarativo come React, adottare questo approccio porterebbe il componente principale a gestire ampi blocchi condizionali (come costrutti \texttt{switch} o \texttt{if/else}) per determinare quale porzione di interfaccia renderizzare, generando codice rigido, frammentato e difficile da testare.
...
Lo store si occupa inoltre di mantenere il \textit{prompt} relativo all’ultima operazione, in modo da poterlo recuperare facilmente in caso di rigenerazione.
