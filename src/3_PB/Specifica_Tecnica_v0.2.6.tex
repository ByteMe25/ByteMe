...
\begin{longtable}{|>{\centering\arraybackslash}p{0.10\textwidth}|>{\centering\arraybackslash}p{0.12\textwidth}|>{\centering\arraybackslash}p{0.18\textwidth}|>{\raggedright\arraybackslash}p{0.35\textwidth}|>{\raggedright\arraybackslash}p{0.15\textwidth}|}
    ...
    \hline
    \endhead
        0.2.6 & 04/05/2026 & Elisa Marchioro & Mini fix a design pattern frontend & Giulia Barzon, Matteo Cuogo\\
        \hline
        0.2.5 & 29/04/2026 & Elisa Marchioro & Sistemata sezione design pattern frontend & Giulia Barzon, Matteo Cuogo\\
        \hline
        0.2.4 & 29/04/2026 & Matteo Cuogo & Sistemazione layered architecture & Giulia Barzon, Elisa Marchioro\\
        \hline
        0.2.3 & 29/04/2026 & Joseph Grant & Aggiunta diagrammi hook, correzione diagrammi & Matteo Cuogo, Elisa Marchioro\\
        \hline
        0.2.2 & 26/04/2026 & Giulia Barzon & Aggiornati diagrammi frontend & Joseph Grant, Elisa Marchioro\\
        \hline
        0.2.1 & 25/04/2026 & Giulia Barzon & Aggiornamento requisiti soddisfatti & Joseph Grant, Elisa Marchioro\\
        \hline
        ...
        \hline
        0.1.7 & 23/04/2026 & Giulia Barzon & Aggiunte componenti AI, migliorata sezione 3 & Matteo Cuogo\\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.20\textwidth}|p{0.10\textwidth}|p{0.55\textwidth}|}
        ...
        \hline
        \gls{Playwright} & 1.59.1 & Framework open-source per test end-to-end che automatizza browser e simula l’utente reale per verificare il funzionamento dell’app. \\
        \hline
    \end{tabular}
...
\begin{enumerate}
    ...
    \item \textbf{Miglioramento della testabilità}: Ogni \textit{ConcreteStrategy} può essere testata in isolamento.
\end{enumerate}
...
\texttt{Axios}: è stata invece adottata un'architettura a due "strati", 
in cui il Facade si occupa del \textit{come} comunicare con il server, e il modulo aiCall.ts del 
