...
\hline
TA-18 & \textbf{Azione:} L'utente, dopo aver utilizzato una funzionalità AI diversa da Distant Writing, decide di rigenerare la risposta. \newline \textbf{Esito atteso:}. L'editor non subisce modifiche e viene generata una nuova risposta che rimane nuovamente in attesa di un input dall'utente. & RO-F-38  & S \\
\hline
TA-19 & \textbf{Azione:} L'utente vuole generare del testo con la funzionalità di Distant Writing. \newline \textbf{Esito atteso:}. Viene presentato all'utente uno spazio in cui scrivere il prompt da inviare all'LLM per la generazione, il sistema non permette di inviare un prompt vuoto; se è presente del testo nell'editor, viene mandato come contesto al modello, se presente una selezione viene mandata solo questa; successivamente il testo generato viene presentato in attesa di un ulteriore input. & RO-F-43, RO-F-57, RO-F-58, RO-F-59, RO-F-60  & S \\
\hline
TA-20 & \textbf{Azione:} L'utente vuole rigenerare la risposta generata dalla funzionalità di Distant Writing. \newline \textbf{Esito atteso:}. Viene nuovamente presentato all'utente uno spazio in cui scrivere il prompt da inviare all'LLM per la generazione, nello spazio viene reso disponibile il prompt precedente modificabile; se presente, il contesto inviato in precedenza viene inoltrato nuovamente al modello insieme al nuovo prompt. & RO-F-38, RO-F-43, RO-F-57, RO-F-58, RO-F-59  & S \\
\hline
...
\hline
TA-26 & \textbf{Azione:} L'utente vuole utilizzare una funzionalità AI, diversa dal Distant Writing, senza aver inserito testo nell'editor. \newline \textbf{Esito atteso:}. Il sistema notifica l'utente della mancanza di testo su cui effettuare l'operazione e interrompe la richiesta. & RO-F-30, RO-F-39  & S \\
\hline
TA-27 & \textbf{Azione:} L'utente vuole utilizzare una funzionalità AI ma, durante l'operazione, si verifica un errore lato client o server. \newline \textbf{Esito atteso:}. Il sistema notifica l'utente dell'errore. & RO-F-30, RO-F-39  & S \\
\hline
...
\hline
TA-39 & \textbf{Azione:} L'utente vuole formattare testo secondo la sintassi \gls{Markdown} senza utilizzare la toolbar. \newline \textbf{Esito atteso:}. Il testo appare correttamente formattato nell'anteprima. & RD-F-1 & S \\
\hline
...
\hline
TA-46 & \textbf{Azione:} L'utente vuole salvare il documento in un sistema di persistenza non locale. \newline \textbf{Esito atteso:}. Il sistema permette verifica che l'utente sia autenticato, altrimenti lo notifica, e salva il documento nel database associandolo all'account dell'utente; il sistema non permette il salvataggio di file vuoti. & ROP-F-35, ROP-F-36, ROP-F-37, ROP-F-38, ROP-F-39, ROP-F-40, ROP-F-41  & NI \\
\hline
TA-47 & \textbf{Azione:} L'utente vuole effettuare il login nel sito e caricare un file precedentemente salvato. \newline \textbf{Esito atteso:}. Il sistema verifica che le credenziali inserite dall'utente siano corrette, notificandolo in caso di errore, e rimanda alla pagina di amministrazione del profilo in cui l'utente può scegliere un file da caricare da una lista di file precedentemente salvati; alla selezione il sistema carica il file nell'editor; l'utente può annullare l'operazione di caricamento dopo aver selezionato il file, lasciando l'editor nello stato iniziale. & ROP-F-19, ROP-F-20, ROP-F-21, ROP-F-31, ROP-F-32, ROP-F-33, ROP-F-34  & NI \\
\hline
TA-48 & \textbf{Azione:} L'utente vuole creare un nuovo account nel sito. \newline \textbf{Esito atteso:}. Il sistema verifica che le credenziali inserite dall'utente siano corrette, notificandolo in caso di errore; il sistema salva nel database il nuovo account una volta che la registrazione è avvenuta con successo. & ROP-F-22, ROP-F-23, ROP-F-24, ROP-F-25 & NI \\
\hline
TA-49 & \textbf{Azione:} L'utente vuole eliminare il suo account dal sito. \newline \textbf{Esito atteso:}. Il sistema verifica che l'utente sia autenticato; il sistema chiede conferma della rimozione; in caso di conferma da parte dell'utente, l'account e i relativi documenti associati vengono rimossi dal database; la sessione viene terminata e l'editor viene riportato allo stato iniziale; in caso di annullamento dell'operazione, l'editor e il database rimangono invariati. & ROP-F-26, ROP-F-27, ROP-F-28, ROP-F-29, ROP-F-30 & NI \\
\hline
