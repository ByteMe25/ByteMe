...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        1.2.2 & 26/04/2026 & Chiara Grossele & Aggiunta test nella sezione \textit{test model strategies.py}& \\
        \hline
...
\prossimoUT & \gls{Verifica} che la strategia Llama formatti correttamente la richiesta per il client OpenAI (utilizzando un \textbf{Mock} dell'\gls{API} di rete per garantire l'isolamento del test) & Pass \\ \hline
\prossimoUT & \gls{Verifica} che la strategia Qwen3 formatti correttamente la richiesta per il client OpenAI (utilizzando un \textbf{Mock} dell'\gls{API} di rete per garantire l'isolamento del test). & Pass \\ \hline
\prossimoUT & \gls{Verifica} che la strategia Gemma3 formatti correttamente la richiesta per il client OpenAI (utilizzando un \textbf{Mock} dell'\gls{API} di rete per garantire l'isolamento del test). & Pass \\ \hline
