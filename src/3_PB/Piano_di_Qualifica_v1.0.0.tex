...
\begin{titlepage}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|l|p{5cm}|}
            ...
            \hline
            \textbf{Verifica} & Elisa Marchioro, Giulia Barzon, Chiara Grossele \\
            \hline
...
\begin{itemize}
    ...
    \item \textbf{Norme di Progetto v1.0.0:} Documento interno del gruppo che definisce regole, strumenti e procedure.
...
Tuttavia, la ridistribuzione dei carichi di lavoro ha permesso di recuperare il gap già negli Sprint successivi (4 e 6) e di chiudere lo Sprint 7 in perfetto orario (SPI a 1.65) e con un saldo temporale tornato in positivo. L'andamento a "V" del grafico dimostra un'ottima capacità di reazione del team agli imprevisti temporali. L'obiettivo del team è rendere l'indice più stabile nella prossima fase di PB attraverso una migliore pianificazione delle attività.
