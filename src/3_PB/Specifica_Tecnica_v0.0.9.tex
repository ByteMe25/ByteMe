...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        0.0.10 & 20/04/2026 & Elisa Marchioro & Fix alle tabelle & \\
        \hline
...
% Definisci una volta sola le larghezze delle colonne
% Nome: 0.20, Versione: 0.10, Descrizione: 0.55 (totale ~0.85 per i margini interni)
