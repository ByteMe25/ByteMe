...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        0.0.9 & 20/04/2026 & Giulia Barzon & Mappatura requisiti soddisfatti (una parte) & \\
        \hline
...
\hline
RO-F-82 & Il sistema deve garantire la persistenza locale dello storico delle generazioni AI tramite browser storage (Zustand persist). & Soddisfatto \\
\hline
...
\hline
RO-V-5 & Il backend dell'applicazione deve essere progettato come un gateway stateless; non deve mantenere sessioni o stati dei documenti sul server, delegando la gestione della persistenza interamente al client. & Soddisfatto \\
\hline
\addlinespace[1em]
