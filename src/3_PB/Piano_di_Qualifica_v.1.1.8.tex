...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        1.1.8 & 24/04/2026 & Joseph Grant & Aggiunta sezione \gls{distant writing} & \\
        \hline
...
\subsubsection{\gls{Distant writing}}
 ...
 \begin{itemize}
    \item \textbf{deepseek-r1 (8b):} Che ha ottenuto un indice di Gulpease di 63, contro la media di 55 ottenuta dagli altri modelli.\\
 \end{itemize}
Abbiamo deciso di usare il seguente \gls{prompt}, che si aggiunge all'input dell'utente: 
\begin{verbatim}
...
\end{verbatim} 
Questo \gls{prompt} cerca di assicurare il corretto tono per la richiesta dell'utente e di costringere l'IA a focalizzarsi sulla correttezza e qualità del testo.
