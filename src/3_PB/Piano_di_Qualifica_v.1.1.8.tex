...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|>{\raggedright\arraybackslash}p{0.35\textwidth}|p{0.18\textwidth}|}
        ...
        \hline
        1.1.8 & 24/04/2026 & Joseph Grant & Aggiunta sezione distant writing & \\
        \hline
...
\subsubsection{\gls{Distant writing}}
 ...
 \end{itemize}
Abbiamo deciso di usare il seguente prompt, che si aggiunge all'input dell'utente: 
\begin{verbatim}
...
\end{verbatim} 
Questo prompt cerca di assicurare il corretto tono per la richiesta dell'utente e di costringere l'IA a focalizzarsi sulla correttezza e qualità del testo.
