...
Questo documento descrive i test relativi al modulo app, che rappresenta il backend dell’applicazione basato su \gls{Flask}.
...
I test verificano il corretto funzionamento dell’\gls{endpoint}, la \gls{validazione} degli input, la gestione degli errori e la coerenza del formato delle risposte. Viene inoltre testata la funzione di pulizia dell’output, che rimuove eventuali frasi introduttive generate dal modello.
