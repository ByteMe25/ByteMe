...
\prossimoUT & Verifica che la strategia Llama formatti correttamente la richiesta per il client OpenAI (utilizzando un \textbf{Mock} dell'API di rete per garantire l'isolamento del test) & Pass \\ \hline
\prossimoUT & Verifica che la strategia Gemma3 formatti correttamente la richiesta per il client OpenAI (utilizzando un \textbf{Mock} dell'API di rete per garantire l'isolamento del test). & Pass \\ \hline
